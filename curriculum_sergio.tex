...
\item Desarrollo y modificacion de BSP's para sistema operativo de tiempo real RTEMS.
\item Desarrollo de aplicaciones para correr en sistema operativo en tiempo real RTEMS.
...
\item Librerias graficas: GTK+ (C, C\#, Perl y Python), Windows MFC.
