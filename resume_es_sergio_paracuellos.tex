...
{\sl Real Time Linux with PREEMPT\_RT Training} \\
Bootlin: Embedded Linux and Kernel engineering (Remote) \hfill Mayo 2022
...
{\sl General Electric} \hfill Marzo 2020 -- Actualidad\\
\hfill Ingeniero senior de software embebido
\begin{itemize} \itemsep -2pt % Reduce space between items
\item Desarrollo de BSP's usando GNU/Linux: yocto.
\item Virtualización sobre vxWorks SR640 para plataformas intel.
\item Desarrollo de drivers vxbus para vxWorks 7: IRIG-B, GPIO, Serie.
\item Desarrollo de aplicationes genericas para correr en sistemas compatibles POSIX con capacidades de tiempo real: vxWorks 7, linux preempt-rt.
\item Porting y mantenimiento del software de control de automatización industrial Straton de COPA-DATA: linux, vxWorks 7.
\item Despliegue de un sistema de CI/CD para todo el sistema de construccion de artefactos y tests on host (docker + github).
\item Principales plataformas hardware: Advantech Intel Industrial, NXP iMX8, Xilinx Zynq and ultrascale+MPSoC.
\item Todos los desarrollos tienen como lenguaje predominantes C, C++, python y bash. 
\end{itemize}

{\sl Aingura IIoT (GRUPO ETXE-TAR)} \hfill Noviembre 2018 -- Marzo 2020\\
\hfill Ingeniero senior de software embebido
\begin{itemize} \itemsep -2pt % Reduce space between items
\item Desarrollo de BSP's usando GNU/Linux: yocto.
