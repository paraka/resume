...
\item Development of Real Time Operating System ARINC-653 compatible for targets using SOC Zync 7000.
...
\item BSP's development and modification for RTOS RTEMS.
\item Development of application to run over RTOS RTEMS.
